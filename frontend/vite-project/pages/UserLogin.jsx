  ...
  return (
    ...
    <form className='space-y-4 mt-6' onSubmit={handleSubmit}>
      ...
      <div className='flex items-center justify-center gap-4 mt-5'>
        <h1 className='font-medium'>New to UBER?</h1>
        <Link to={"/user-signup"} className='text-blue-800'>Create an Account</Link>
      </div>
    ...
    <button className='w-3/4 h-10 bg-black text-white rounded shadow ml-11 mt-11 pb-1 font-normal text-xl text-center active:scale-95 transition transform duration-150' onClick={()=>{navigate("/captain-login")}}>Login as Captain</button>
    </div>
    </>  
